...
<body>
    ...
    <main>
        <div class="container">
            <form class="ma" action="${pageContext.request.contextPath}/front/forgetpwd.action" method="post" >
                <div class="form_header">
                    ...
                    <div class="form_back">
                        <a href="${pageContext.request.contextPath}/front/index.action">返回立即登录</a>
                    </div>
                </div>
                <div class="form_body">
