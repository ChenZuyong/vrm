	...
	<menu>
		<div class="container clearfix">
			<ul class="clearfix f_left">
				<li><a href="${pageContext.request.contextPath}/front/index.action">首页</a></li>
				<li class="menu_active"><a href="${pageContext.request.contextPath}/front/user/indivadualindex.action">个人中心</a></li>
			</ul>
		<div id="user_bar">
